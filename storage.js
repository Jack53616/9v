...
MysqlStore.prototype.insertUnused = async function (row) {
  ...
  await this.pool.query(
    'INSERT INTO licenses (key_hash, key_suffix, plan, status, billing, created_by, created_at) VALUES (?, ?, ?, \'unused\', ?, ?, ?)',
    [row.key_hash, row.key_suffix, row.plan, billing, row.created_by, new Date()]
  );
};
